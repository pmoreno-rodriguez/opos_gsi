...
### Resumen de aspectos y actuaciones a considerar <!-- {docsify-ignore} -->
...
### Designación de Delegado de Protección de Datos (DPD) en AAPP <!-- {docsify-ignore} -->
...
### Elaboración de Registro de Actividades (RAT) <!-- {docsify-ignore} -->
...
- Identidad y datos de contacto del responsable, representante, y DPD.
...
### Bases Jurídicas de los Tratamientos <!-- {docsify-ignore} -->
...
### Tratamientos de Alto Riesgo y Evaluación de Impacto <!-- {docsify-ignore} -->
...
- **Art. 10** – **Tratamiento relativo a condenas e infracciones legales**: 
...
### Adecuación de Formularios en el Marco del RGPD <!-- {docsify-ignore} -->
...
#### Modificación de Formularios y Procedimientos
...
### Modelo de Información por Capas <!-- {docsify-ignore} -->
...
### Principales Necesidades de Adaptación <!-- {docsify-ignore} -->
...
Es fundamental establecer procedimientos y formularios que faciliten la recogida de información en los términos que el RGPD valida. Esto incluye la creación de mecanismos visibles, accesibles y sencillos para el ejercicio de los derechos de los ciudadanos. Entre estos derechos se encuentran:
...
### Encargados de Tratamiento <!-- {docsify-ignore} -->
...
### Políticas de Protección de Datos <!-- {docsify-ignore} -->
...
### Formación y Concienciación sobre el RGPD <!-- {docsify-ignore} -->
...
### Documentación Adicional: Consejos Prácticos para la Implementación del RGPD <!-- {docsify-ignore} -->
...
1. **Impacto del RGPD en las Administraciones Públicas**  
...
### Consejos Prácticos para la Aplicación del RGPD <!-- {docsify-ignore} -->
