# Supuesto 1: Posibles Preguntas del B3 y Posibles Preguntas Complementarias de B4

## Diagrama de Casos de Uso
- **5** Diagrama de casos de uso

## Diagrama de Clases / Modelo Entidad-Relación
...
## Arquitectura Tecnológica para Movilidad
...
### Posibles Preguntas del Bloque 4 en el Supuesto 1 más de Bloque 3
