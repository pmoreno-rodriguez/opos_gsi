...
### IAS 01: Establecimiento del plan de implantación :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 02: Formación necesaria para la implantación :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 03: Incorporación del sistema al entorno de operación :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 04: Carga de datos al entorno de operación :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 05: Pruebas de implantación del sistema :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 06: Pruebas de aceptación del sistema :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 07: Preparación del mantenimiento del sistema :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 08: Establecimiento del acuerdo de nivel de servicio :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 09: Presentación y aprobación del sistema :class=titulo-color <!-- {docsify-ignore} -->
...
### IAS 10: Paso a producción, paso final de la Implantación y Aceptación del SI :class=titulo-color <!-- {docsify-ignore} -->
